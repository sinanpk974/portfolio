export default function Hero() {
  return (
    <section className="relative h-screen flex flex-col justify-center items-center text-center px-6 py-20 overflow-hidden 
    bg-gradient-to-br from-gray-100 via-blue-50 to-gray-200">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <p className="text-md md:text-lg mb-6 px-6 md:px-0 max-w-2xl mx-auto text-gray-700 leading-relaxed">
        ...
        <a
          href="#projects"
          className="inline-block bg-blue-500 hover:bg-blue-600 px-5 py-3 rounded-lg text-white text-lg font-semibold transition shadow-md hover:shadow-lg "
        >
          View Projects
        </a>
